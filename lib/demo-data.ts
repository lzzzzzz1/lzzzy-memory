...
export const demoTrip: Trip = {
  ...
  memories: [{ id: "demo-memory", placeId: "osaka", visitId: "demo-visit", title: "雨前的霓虹", body: "我们绕过拥挤的人群，在河边等到招牌一点点亮起来。你说这座城市像一封没有写完的信。", occurredOn: "2026-06-15", media: [], version: 1 }],
};
